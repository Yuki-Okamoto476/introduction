...
|TOEIC|860点|
|出身大学・学部|同志社大学 法学部
|その他|University of the PeopleでComputer Science専攻（2023.11〜）
...
#### 発揮したバリュー2
##### 【課題・状況】
①バックエンドで長年アップデートされていないことで、脆弱性の指摘やサポートがもうすぐ切れるライブラリが複数存在していた
...
##### 【行動】
ライブラリのバージョンアップに着手。<br>
②の課題に対しては、ライブラリをアップデートしたときに吐き出されるエラーから、どのライブラリがどのライブラリに依存しているか、どのバージョンなら解決できるかを紐解いて整理。<br>
...
- エラーパターンを含め全ての例外パターンを実装することで、エラー時のユーザーのとるべき行動をわかりやすくした。
