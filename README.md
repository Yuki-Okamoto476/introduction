...
- 企画前のユーザーインタビュー（自身もインタビュワーとして参加）で大企業の人事部は配属案検討の工数がかなりかかっている事実があること、自分が商談を行った企業も同様の課題を抱えていること、競合にも同じような機能があることから、配属効率化のニーズは確実にあると考え引き続き足りない機能を増やしていくことにした。配属を決めるために使うデータは各社様々でどれから優先的に開発するか迷ったが、10社ほどに行ったインタビューや商談を振り返り、業界問わず「配属先部署の必要人数」を加味した配属は基本的に行っていることや開発工数の観点からまずは必要人数を加味した配属案出力の機能を作るという企画書を作成し提案。

##### 【結果】

本機能に価値を感じてくれたとある1社のエンプラ企業への導入が決定。引き続き営業活動・機能の拡充に取組中。
